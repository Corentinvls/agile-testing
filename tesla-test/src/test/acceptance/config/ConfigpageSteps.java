...
public class ConfigpageSteps {
	...
	public void je_suis_sur_la_page_configurateur() {
		driver.get("https://www.tesla.com/fr_fr/models");
	}

	@When("^je clique sur le bouton commander$")
	public void je_clique_sur_le_bouton_commander() {
	...
	public void l_url_de_la_page_doit_être(String arg1) {
		assertEquals(arg1, driver.getCurrentUrl());
	}

	@Then("^le prix affiché est un prix \"([^\"]*)\" avec \"([^\"]*)\"$")
	public void le_prix_affiché_est_un_prix_avec(String arg1, String arg2) {
		...
		String LOA = driver.findElement(By.xpath(xPathLOA)).getAttribute("innerHTML").substring(0, 3);
		String price = driver.findElement(By.xpath(xPathPrice)).getAttribute("innerHTML");
		assertEquals(arg1, LOA);
		assertEquals(arg2, price);
	}

	@When("^je sélectionne le modèle \"([^\"]*)\"$")
	public void je_sélectionne_le_modèle(String arg1) {
	...
	public void une_économies_de_carburant_estimées_avec(String arg1) {
	...
	public void un_montant_total_avec_achat_au_terme_du_contrat_de(String arg1) {
	...
	public void je_veux_la_capacité_de_conduite_entièrement_autonome() {
	...
	public void le_prix_augmente_de_€_mois(int arg1) {
		assertEquals(priceLoaWithAutoPilot - priceLoa, arg1);
	}

	@When("^je navique et click sur le lien Localisation$")
	public void je_navique_et_click_sur_le_lien_Localisation() throws InterruptedException {
